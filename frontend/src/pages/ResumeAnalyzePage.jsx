    ...
    <AppShell title="Resume analysis">
      <PageHeader
        ...
        actions={
          ...
          >
            <RefreshCw
              className={analysis.loading ? "size-4 animate-spin" : "size-4"}
              aria-hidden
            />
            Re-analyse
          </Button>
      ...
      {analysis.data ? (
        <>
          <SectionCard
            ...
            description={`Target role: ${analysis.data.targetRole}`}
          >
                  ...
                  <div className="grid gap-3 lg:grid-cols-2">
                    ...
                    <div className="rounded-sm border border-accent/20 bg-accent-subtle/50 p-3.5">
                      ...
                      {editing === s.id ? (
                        ...
                        <p className="mt-1.5 text-xs sm:text-sm font-medium text-foreground leading-relaxed">
                          {edits[s.id] ?? s.suggestion}
                        </p>
                      )}
      ...
      <SectionCard
        title="Final resume"
        description="Preview and export once you have reviewed the suggestions."
      >
        <div className="rounded-sm border border-border bg-surface-hover/50 p-4 sm:p-5">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          ...
          <Button onClick={() => toast("Saving connects to the FastAPI resume endpoint.")}>
            Save resume
          </Button>
          <Button
            variant="outline"
            onClick={() => toast("Export is generated by the backend document service.")}
          >
