      ...
      <div className="grid gap-4 xl:grid-cols-[1.4fr_1fr]">
            ...
            {current.key === "personal" ? (
              <>
                ...
                <div className="rounded-sm border border-accent/20 bg-accent-subtle/50 p-3.5">
                  ...
                  {aiSummary ? (
                    <p className="mt-2 text-xs sm:text-sm text-foreground">{aiSummary}</p>
                  ) : null}
        ...
        <div className="space-y-4">
            ...
            <div className="space-y-2">
              {TEMPLATES.map((t) => (
                <button
                  ...
                  className={`w-full rounded-sm border p-3 text-left transition-colors cursor-pointer ${
                    template === t.id
          ...
          <SectionCard title="Preview" description="Live outline of the resume you are building.">
            <div className="space-y-2 rounded-sm border border-border bg-surface-hover/50 p-4 text-sm">
              <p className="font-semibold text-foreground">{values["fullName"] || "Your name"}</p>
              <p className="text-xs text-muted-foreground">
                {[values["email"], values["location"]].filter(Boolean).join(" · ") ||
                  "Contact details"}
              </p>
              <p className="text-muted-foreground text-xs sm:text-sm">
                {values["summary"] || "Professional summary appears here."}
              </p>
