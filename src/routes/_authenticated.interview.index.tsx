...
export const Route = createFileRoute("/_authenticated/interview/")({
  head: () => ({
    meta: [
      { title: "Interview Preparation — FutureReady" },
      {
        name: "description",
        content:
          "Role and company-specific interview preparation across DSA, coding, technical, project and HR rounds.",
      },
      { property: "og:title", content: "Interview Preparation — FutureReady" },
      { property: "og:description", content: "Readiness, weak areas and today's preparation goal." },
    ],
  }),
...
const LOOP = ["Skill gap", "Recommended task", "Your practice", "Result", "Updated skill", "Next task"];
      ...
      {data ? (
        <>
          <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            <StatTile label="Role" value={data.setup.role} hint={`Company: ${data.setup.company}`} />
          ...
          <SectionCard title="Preparation dashboard" description="Overall readiness and category progress.">
          ...
          <SectionCard title="Adaptive preparation loop" description="Each result feeds the next recommended task.">
